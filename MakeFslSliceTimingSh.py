...
def main(In,Out,shPath,ClusterError,ClusterOutput,tfile):


    fslCMD='-i '+In+' -o '+Out+' --tcustom='+tfile                        
    ...
    shFile.write('#$ -l mem_free=2G\n')
    shFile.write('#$ -l h_vmem=3G\n')
    ...
    shFile.write("${FSL_DIR}/bin/slicetimer"+' {}'.format(fslCMD))
    shFile.close()
    return()
