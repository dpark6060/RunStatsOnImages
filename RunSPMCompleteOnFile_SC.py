...
import numpy as np
import time
import MakeMatlabSh_SC as SPMsh
...
def MakeSliceTimingJobs(Nii,Fs,itl,OutDir):
    ...
    jobTemplate='/home/dparker/Documents/MATLAB/SliceTimingTemplate_job.m'
    ...
    Template='/home/dparker/Documents/MATLAB/SliceTimingTemplate.m'
    File=open(Template)
    Template=File.read()
    File.close
